...
;
; ; MusicBlk_Sample:
; ; 		binclude "sound/music/musictrck_blk.bin"		; BLOCKS data
; ; MusicPat_Sample:
; ; 		binclude "sound/music/musictrck_patt.bin"		; PATTERN data
...
;
; MusicBlk_TestMe:
; 		binclude "sound/oldmusic/lasttest_blk.bin"		; BLOCKS data
; MusicPat_TestMe:
; 		binclude "sound/oldmusic/lasttest_patt.bin"		; PATTERN data
; MusicIns_TestMe:
; 		instrSlot -1
; 		instrSlot -1
; 		instrSlot -1
...
;
; MusicBlk_Gigalo:
; 		binclude "sound/oldmusic/gigalo_psg_blk.bin"
; MusicPat_Gigalo:
; 		binclude "sound/oldmusic/gigalo_psg_patt.bin"
; MusicIns_Gigalo:
