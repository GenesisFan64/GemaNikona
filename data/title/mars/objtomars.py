...
out_head.write('.vert:\t\tbinclude "data/title/mars/mdl/'+object_name+'/vert.bin"\n')
out_head.write('.face:\t\tbinclude "data/title/mars/mdl/'+object_name+'/face.bin"\n')
out_head.write('.vrtx:\t\tbinclude "data/title/mars/mdl/'+object_name+'/vrtx.bin"\n')
out_head.write('.mtrl:\t\tinclude "data/title/mars/mdl/'+object_name+'/mtrl.asm"\n')
